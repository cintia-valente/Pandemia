...
<ol>
  ...
  <li>Faça o restore do banco de dados, conforme documentação do mongoDB: https://docs.mongodb.com/database-tools/mongorestore/#bin.mongorestore
      O banco de dados está localizado na pasta <b>database</b> dentro da pasta backend, </li>
