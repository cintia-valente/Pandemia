...
# Pandemia 
Projeto da incubadora do Centro de Inovação Microsoft PUCRS em parceria com a empresa DBServer. O projeto que tem como objetivo permitir que autoridades de saúde acompanhem a evolução de atendimentos e testes durante uma epidemia. 
...
<ol>
  ...
  <li>Faça o restore do banco de dados, localizado na pasta <b>database</b>, conforme documentação do mongoDB: https://docs.mongodb.com/database-tools/mongorestore/#bin.mongorestore</li>
